...
installTheme(){
    ...
    rm -r Utama
    git clone https://github.com/BotKtps/Utama.git
    cd Utama
...
repair(){
    bash <(curl https://raw.githubusercontent.com/BotKtps/Utama/main/repair.sh)
}
...
echo ""
echo "Wa: +62 821-5891-0417"
echo "Nama: mirk store"
echo ""
